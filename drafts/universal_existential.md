# Universal and existential quantifications in Rust, Swift and Haskell
...
Haskell doesn't have an equivalence of `impl X` or `some X` since values are usually boxed.
