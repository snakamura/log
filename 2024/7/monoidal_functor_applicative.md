...
In Haskell syntax, this is a bit confusing because we use `->` for both morphisms and exponential objects. It might be easier to understand this by writing like this.
